...
insert into studentAthlete(name, email, school, major, yearsInSchool, sport, password) values("Diamond Stone", "diamondstone@umd.edu", "Maryland", "Math", 1, "Basketball", "diamond");
